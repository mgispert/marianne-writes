        ...
        <Flex as="nav" bg="#0000008f" p={4} mb={10}>
            ...
            >
                ...
                >
                    <ChakraLink
                        as={Link}
                        href="https://www.instagram.com/authormariannegrey"
                        color="white"
                        target="_blank"
                    >
                        <FaInstagram />
                    ...
                    <ChakraLink
                        as={Link}
                        href="https://www.goodreads.com/author/list/41662510.Marianne_Grey"
                        color="white"
                        target="_blank"
                    >
                        <FaGoodreads />
                    ...
                    <ChakraLink
                        as={Link}
                        href="https://www.etsy.com/shop/TheShadowedScroll"
                        color="white"
                        target="_blank"
                    >
                        <FaEtsy />
