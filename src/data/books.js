const books = [
    {
        ...
        isbn: "Coming Soon", // Replace with real ISBN
    ...
    <br/> But one thing is certain: I will find my family, no matter the cost. The question is, what will I become in the process?`,
        ...
        bookshop: null, // Add this
        etsy: "https://www.etsy.com/shop/TheShadowedScroll",
        map: "/images/osaa-map.png",
        art: [
            "/images/osaa-art.jpg",
            "/images/osaa-art1.PNG",
            "/images/osaa-art2.png",
            "/images/osaa-art3.png",
        ],
    },
    {
        id: 2,
...
`,
    ...
    {
        id: 3,
        title: "Of Heirs and Monsters",
        isbn: "Coming Soon",
        cover: "/images/placeholder.jpg",
        isComingSoon: true,
        blurb: `The shadows of The Nether are lengthening, and the final battle for the throne is about to begin. <br/>The epic conclusion to the Echoes of Darkness trilogy is currently being woven. Check back soon for the cover reveal and official blurb.`,
        tropes: [
            "The Final Evil",
            "Secrets Revealed",
            "Treacherous Allies",
